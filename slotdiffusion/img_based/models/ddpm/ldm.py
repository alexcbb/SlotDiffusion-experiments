...
# TODO : implement the model such as it reconstructs DINO features
class LDMDINO(CondDDPM):
    """Latent Diffusion Model that reconstruct the feature space from DINO model
        instead of latent from VQ-VAE."""
